                                            ...
                                            <li data-list-text={3}>
                                                ...
                                                <ol id="l2">
                                                    <li data-list-text="a.">
                                                        ...
                                                        >
                                                            Block 1-16. Fill in all numbered blocks. If "Not Applicable"
                                                            or
                                                            "None", so state. If "Other" is marked for any response,
                                                            please
                                                            explain in the blank space provided, or in Block 11,
                                                            Description of
                                                            Incident.
                                                        </p>
                                                    </li>
                                                    <li data-list-text="b.">
                                                        ...
                                                        >
                                                            Block 5. For those incidents involving harm, or the
                                                            potential for
                                                            harm, to a patient (inpatient or outpatient), refer to MTF
                                                            Patient
                                                    ...
                                                    <li data-list-text="c.">
                                                        ...
                                                        >
                                                            ...
                                                            <span className="s15">not </span>classified as a Patient
                                                            Safety
                                                            event, i.e., personal harm, or the risk of harm, was not
                                                            present.
                                                            Examples include: loss of valuables, a verbal altercation
                                                            with
                                                            another patient, etc.
                                                        </p>
                                                    </li>
                                                    <li data-list-text="d.">
                                                        ...
                                                        >
                                                            Block 7. (1) For an adverse drug reaction, also complete FDA
                                                            Form
                                                        ...
                                                        <ol id="l3">
                                                            <li data-list-text="(2)">
                                                                ...
                                                                >
                                                                    For a blood products reaction, also complete the
                                                                    bottom portion
                                                                    of SF 518, Medical Record - Blood or Blood Component
                                                                    Transfusion
                                                            ...
                                                            <li data-list-text="(3)">
                                                                ...
                                                                >
                                                                    For patients who depart AMA/Left without Being Seen,
                                                                    also
                                                                    complete DA Form 5009, Release Against Medical
                                                                    Advice.
                                                                </p>
                                                            </li>
                                                            <li data-list-text="(4)">
                                                                ...
                                                                >
                                                                    For medical equipment related incidents, contact
                                                                    Logistics
                                                    ...
                                                    <li data-list-text="e.">
                                                        ...
                                                        >
                                                            ...
                                                            psychological) sustained by those involved in the incident
                                                            being
                                                            reported. Individuals who are injured as a result of an
                                                            incident or
                                                            adverse event should be referred immediately for medical
                                                            attention.
                                                        </p>
                                                        <p
                                                            style={{
                                                        ...
                                                        >
                                                            The facility Risk Manager will be notified of any incident
                                                            that
                                                    ...
                                                    <li data-list-text="f.">
                                                        ...
                                                        >
                                                            Block 9. List any witnesses to the event that may be asked
                                                            to
                                                    ...
                                                    <li data-list-text="g.">
                                                        ...
                                                        >
                                                            Block 10. Note the departments involved with this incident
                                                            to ensure
                                                    ...
                                                    <li data-list-text="h.">
                                                        ...
                                                        >
                                                            Block 11. Provide a brief but concise explanation of what
                                                            occurred.
                                            ...
                                            <li data-list-text={5}>
                                                ...
                                                <ol id="l4">
                                                    <li data-list-text="a.">
                                                        ...
                                                        >
                                                            Actual Event/Incident - A situation that did occur either
                                                            with or
                                                    ...
                                                    <li data-list-text="b.">
                                                        ...
                                                        >
                                                            Harm - Personal injury or damage of a physical or a
                                                            psychological
                                                    ...
                                                    <li data-list-text="c.">
                                                        ...
                                                        >
                                                            ...
                                                            resulted in harm or injury to the individual(s) involved but
                                                            did
                                                            not, either by chance or through timely intervention. The
                                                            event was
                                                            identified and resolved before reaching the individual(s)
                                                            involved.
                                                        </p>
                                                    </li>
                                                </ol>
